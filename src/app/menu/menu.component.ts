        ...
        items: [
          {
            ...
            icon: 'pi pi-pencil',
            items: [
              { label: 'Assignment 1.1 - Background Color ', icon: 'pi pi-fw pi-file-edit', routerLink:['/colorForm'] },
              { label: 'Assignment 1.2 - Dog Form', icon: 'pi pi-fw pi-file-edit', routerLink:['/dogForm'] },
              { label: 'Assignment 1.3 - Coment Simulation', icon: 'pi pi-fw pi-file-edit', routerLink:['/comment']},
            ],
          },
          {
            label: 'แบบฝึกหัดที่ 2',
            icon: 'pi pi-pencil',
            items: [{ label: 'Assignment 2.1 - Locator', icon: 'pi pi-fw pi-file-edit', routerLink:['/locator'] }],
          },
